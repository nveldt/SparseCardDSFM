...
void main_func(double * y_sum, double * record, double * record_discrete,
        ...
        unsigned int record_dis, double gaptol, double * timevec,
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[]){
    // [y, record, record_discrete] = RCDM_cversion(incidence_list, parameter_list, submodular_type, bias_vec, N, R, K, T, record_dis, gaptol);
	if (nlhs != 6 || nrhs != 10) {
...
//     plhs[5] = mxCreateDoubleMatrix(record_num, 1, mxREAL);
//     int * sweepi = mxGetInt64s(plhs[5]);
    
    main_func(y_sum, record, record_discrete,
            incidence_list, incidence_list_size,
            parameter_list, parameter_list_size,
            submodular_type, submodular_type_size,
            bias_vec, N, R, K, T, record_dis, gaptol,timevec, Xmat,sweepi);
